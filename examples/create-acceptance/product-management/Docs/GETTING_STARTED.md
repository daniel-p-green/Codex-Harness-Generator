...
2. Ask Codex to map PRDs, roadmaps, issues, and stakeholder notes.
3. Ask for one scoped PRD or acceptance-criteria pass.
4. Ask the reviewer to inspect tradeoffs and unsupported priorities.
...
Use this loop for the first real product management task so the harness produces
