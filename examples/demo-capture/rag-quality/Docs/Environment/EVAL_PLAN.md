...
- Codex follows the LLM app verification rules in `AGENTS.md`.
...
1. Ask Codex to map prompts, tools, evals, and retrieval sources.
2. Ask for one eval case or prompt-contract improvement.
3. Ask the reviewer to inspect failure modes and privacy risks.
