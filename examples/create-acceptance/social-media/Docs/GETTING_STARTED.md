...
2. Ask Codex to map campaign briefs, source assets, and channels.
3. Ask for one channel-specific post set.
4. Ask the reviewer to inspect claim accuracy and brand fit.
...
Use this loop for the first real social media task so the harness produces
