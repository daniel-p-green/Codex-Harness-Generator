...
- Codex follows the game development verification rules in `AGENTS.md`.
...
1. Ask Codex to map engine, scenes, scripts, assets, and build commands.
2. Ask for one small gameplay or tooling change.
3. Ask the reviewer to inspect build risk and playtest notes.
