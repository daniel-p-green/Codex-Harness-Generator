...
- Codex follows the book publishing verification rules in `AGENTS.md`.
...
1. Ask Codex to map manuscript files and production notes.
2. Ask for a source-faithful edit of one section.
3. Ask the reviewer to inspect continuity and over-editing.
