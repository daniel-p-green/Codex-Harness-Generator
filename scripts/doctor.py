...
def check_installable_cli() -> tuple[dict, dict]:
    ...
    if failed:
        ...
        detail = "profiles={profiles} doctor={doctor_status} init=pass init_from_project={init_from_project_status} validate={validate_status} inspect={inspect_status} adoption_plan={adoption_status} local_eval={local_eval_status} usage_from_harness={usage_from_harness_status} usage_from_issue={usage_from_issue_status} migration_audit={migration_status} eval=pass".format(
