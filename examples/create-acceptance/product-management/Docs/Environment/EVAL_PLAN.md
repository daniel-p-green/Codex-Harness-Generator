...
- Codex follows the product management verification rules in `AGENTS.md`.
...
1. Ask Codex to map PRDs, roadmaps, issues, and stakeholder notes.
2. Ask for one scoped PRD or acceptance-criteria pass.
3. Ask the reviewer to inspect tradeoffs and unsupported priorities.
