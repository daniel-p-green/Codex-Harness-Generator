...
2. Ask Codex to map funder criteria and proposal materials.
3. Ask for one source-backed proposal section.
4. Ask the reviewer to inspect eligibility, budget, and unsupported claims.
...
Use this loop for the first real grant writing task so the harness produces
