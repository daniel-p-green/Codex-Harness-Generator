...
2. Ask Codex to map datasets, notebooks, scripts, and reports.
3. Ask for a metric and leakage-risk review.
4. Ask the reviewer to inspect reproducibility and unsupported conclusions.
...
Use this loop for the first real data science task so the harness produces
