...
- Codex follows the grant writing verification rules in `AGENTS.md`.
...
1. Ask Codex to map funder criteria and proposal materials.
2. Ask for one source-backed proposal section.
3. Ask the reviewer to inspect eligibility, budget, and unsupported claims.
