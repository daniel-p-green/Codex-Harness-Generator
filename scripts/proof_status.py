...
def check_installable_cli() -> tuple[dict, dict]:
    ...
    if failed:
        ...
        detail = "profiles={profiles} doctor={doctor_status} init={init_status} demo_capture={demo_status} validate={validate_status} migration_audit={migration_status} eval={eval_status}".format(
