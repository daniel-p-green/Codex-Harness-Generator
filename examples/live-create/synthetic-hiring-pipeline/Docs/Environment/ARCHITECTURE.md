...
Single-project hiring-pipeline harness with one read-only reviewer agent, one
health-check skill, scoped permissions, and structured decision-support rules.
