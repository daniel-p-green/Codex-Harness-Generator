...
This audit checks whether handoff folders are ready to send; it is not usage proof until a real task is completed and converted into a validated usage record.
