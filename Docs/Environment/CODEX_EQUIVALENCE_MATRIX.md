...
Generated: 2026-06-04T12:30:29Z
Status: PASS
...
| Usage evidence | PASS | Record whether generated harnesses actually help with real tasks. | Usage records, validation thresholds, prepared pilots, pilot packs, and pilot campaigns. | `Docs/Environment/USAGE_RECORDS.md`<br>`Docs/Environment/USAGE_GAPS.md`<br>`Docs/Environment/PILOT_CAMPAIGN.md`<br>`scripts/prepare_pilot.py`<br>`scripts/record_usage_case.py` | `codex-harness prepare-pilot <target>`<br>`codex-harness usage-validate`<br>`codex-harness usage-gaps`<br>`codex-harness pilot-campaign` |
