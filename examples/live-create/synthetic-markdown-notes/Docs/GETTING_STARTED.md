...
2. Ask Codex to map the key docs and their roles.
3. Ask for a concise source-backed summary of one folder.
4. Ask the reviewer to check whether the summary overclaims.
