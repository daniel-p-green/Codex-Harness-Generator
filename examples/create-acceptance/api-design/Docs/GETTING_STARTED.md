...
2. Ask Codex to map existing API docs, schemas, and examples.
3. Ask for a small endpoint spec or API contract check.
4. Ask the reviewer to inspect compatibility and missing examples.
...
Use this loop for the first real API design task so the harness produces
