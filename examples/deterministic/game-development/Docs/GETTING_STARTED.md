...
2. Ask Codex to map engine, scenes, scripts, assets, and build commands.
3. Ask for one small gameplay or tooling change.
4. Ask the reviewer to inspect build risk and playtest notes.
...
Use this loop for the first real game development task so the harness produces
