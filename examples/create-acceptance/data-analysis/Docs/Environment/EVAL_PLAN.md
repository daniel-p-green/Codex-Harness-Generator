...
- Codex follows the data analysis verification rules in `AGENTS.md`.
...
1. Ask Codex to identify datasets, scripts, and output reports.
2. Ask for a metric definition map before changing analysis logic.
3. Ask the reviewer to inspect reproducibility and unsupported claims.
