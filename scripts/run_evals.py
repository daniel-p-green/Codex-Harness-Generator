            ...
            *(
            ...
            run_step(
                ...
                [
                    ...
                    "tests/test_external_pilot_pack.py",
                    "tests/test_pilot_campaign.py",
                    "tests/test_pilot_handoff.py",
                    "tests/test_pilot_handoff_audit.py",
                    ...
                    "tests/test_usage_from_harness.py",
                    "tests/test_usage_from_issue.py",
                    "tests/test_usage_gaps.py",
