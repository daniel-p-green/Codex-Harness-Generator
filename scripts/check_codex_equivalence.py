...
CAPABILITIES = [
    ...
    },
    {
        ...
        "codex_surface": "Proof status, beta-status dashboard, next-action packet, proof matrix, generated-surface refresh, eval trends, source freshness, and semantic alignment.",
        "evidence_paths": [
            ...
            "scripts/beta_status.py",
            "scripts/refresh_generated_surfaces.py",
        ],
        "commands": ["codex-harness refresh-examples", "codex-harness proof-next", "codex-harness proof-status", "codex-harness beta-exit-audit", "codex-harness beta-status", "codex-harness gate"],
    },
    {
        "name": "Source lineage",
