...
2. Ask Codex to map research sources and open questions.
3. Ask for one source-backed market note.
4. Ask the reviewer to inspect assumptions and unsupported claims.
...
Use this loop for the first real market research task so the harness produces
