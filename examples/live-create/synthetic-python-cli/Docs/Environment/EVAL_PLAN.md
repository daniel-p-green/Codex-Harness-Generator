...
- Codex follows the software development verification rules in `AGENTS.md`.
...
1. Ask Codex to explain the CLI entry point.
2. Ask for one tiny change and verify the result.
3. Ask the reviewer to inspect the change before finalizing.
