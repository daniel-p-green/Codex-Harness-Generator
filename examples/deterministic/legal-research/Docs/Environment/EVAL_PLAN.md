...
- Codex follows the legal research verification rules in `AGENTS.md`.
...
1. Ask Codex to map legal sources and open questions.
2. Ask for one source-backed research note.
3. Ask the reviewer to inspect citations and jurisdiction boundaries.
