...
- Codex follows the data engineering verification rules in `AGENTS.md`.
...
1. Ask Codex to map datasets, schemas, and pipeline entry points.
2. Ask for a small data-contract or validation check.
3. Ask the reviewer to inspect data quality and backfill risk.
