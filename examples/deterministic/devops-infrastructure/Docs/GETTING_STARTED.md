...
2. Ask Codex to map environments, deployment files, and runbooks.
3. Ask for a dry-run validation of one small infrastructure change.
4. Ask the reviewer to inspect blast radius and rollback notes.
