...
| The public helper command installs and runs. | `pyproject.toml`, `scripts/codex_harness.py`, `scripts/check_cli_install.py`, `tests/test_cli_install.py`, `.github/workflows/evals.yml` | `python scripts/check_cli_install.py` | A temporary non-editable install exposes `codex-harness`, lists 20 profiles, runs `codex-harness init --brief`, and evaluates the generated harness. |
