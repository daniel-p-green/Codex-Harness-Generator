...
- Codex follows the hiring pipeline verification rules in `AGENTS.md`.
...
1. Ask Codex to map role requirements, criteria, and interview materials.
2. Ask for one structured scorecard or interview guide.
3. Ask the reviewer to inspect bias, privacy, and human-review boundaries.
