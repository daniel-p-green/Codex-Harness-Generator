...
- Codex follows the market research verification rules in `AGENTS.md`.
...
1. Ask Codex to map research sources and open questions.
2. Ask for one source-backed market note.
3. Ask the reviewer to inspect assumptions and unsupported claims.
