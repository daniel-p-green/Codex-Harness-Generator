...
Reference documents for Codex environment design and generation.
...
Model guidance is centered on GPT-5.5 (`gpt-5.5`) and Codex
`model_reasoning_effort`; topic files should avoid provider-specific model
nicknames or stale version markers.

| # | File | Topic | Key Takeaway |
|---|------|-------|-------------|
| 0 | 00-appendix.md | Appendix | Cross-cutting references, glossary, source index |
| 1 | 01-rules.md | Rules | AGENTS.md < 250 lines; intent behind every rule; .codex/rules/ for modularity |
| 2 | 02-agents.md | Agents | 5-element delegation; always set reasoning effort; model selection (high/medium/low reasoning effort) |
...
| 13 | 13-gpt-5-5-specifics.md | GPT-5.5 Model & Prompt Eng | gpt-5.5 default; reason via model_reasoning_effort; concise literal instructions; TOML config examples; eval hooks |
...
| 18 | 18-cost-awareness.md | Cost & Tokens | Subagents ~4x, teams ~15x; effort levels; --max-budget-usd; Cost/performance mode; RTK; VCS ignore rules; AGENTS.md budget |
| 20 | 20-plugins.md | Plugins | Marketplace install; openai/skills repo; intake signal matching |
...
- **Advanced**: 13-gpt-5-5-specifics, 15-testing-validation, 18-cost-awareness, 21-rag-strategies, 23-multi-modal, 00-appendix
...
### Component Generator
Load by pass:
- **Pass 1 (Foundation)**: 01-rules, 05-memory, 08-routing, 11-permissions, 13-gpt-5-5-specifics, 16-hooks, 18-cost-awareness
- **Pass 2 (Agents)**: 02-agents, 13-gpt-5-5-specifics, 18-cost-awareness
