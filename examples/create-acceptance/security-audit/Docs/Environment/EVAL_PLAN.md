...
- Codex follows the security audit verification rules in `AGENTS.md`.
...
1. Ask Codex to map audit scope and sensitive files.
2. Ask for one defensive security review of a small target.
3. Ask the reviewer to inspect evidence, severity, and remediation safety.
